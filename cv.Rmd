...
* Method competencies:
  * Functional neuroimaging: **Advanced** in SPM; **intermediate** in nipype, FSL, **proficient** in nilearn
  * Behavioral tasks: **Advanced** in Gorilla, Qualtrics, PsychoPy
...
```{r}
tribble(
  ~ Position, ~ Why, ~ Year, ~ Institution, ~ Where,
  "Assistant professor", "Dept of Neuroscience, Cognition, & Behavior", "Aug 2025 - present", "University of San Diego", "San Diego, CA, USA",
) %>% 
...
```{r}
# Keep continuing/current ones at the top
tribble(
  ~ Position, ~ Year, ~ Course, ~ Where,
  "Instructor of record", "Fa2026", "NCB 380: Lab-Based Explorations in Neuroscience", "University of San Diego Dept of Neuro, Cog, & Beh",
  "Instructor of record", "Fa2025 - Fa2026", "NCB 210: Intro to Statistics", "University of San Diego Dept of Neuro, Cog, & Beh",
  "Instructor of record", "Sp2026", "NCB 336: Cognitive Psychology", "University of San Diego Dept of Neuro, Cog, & Beh",
...
tribble(
  ~Year, ~Award, ~Desc,
  "Spring 2026", "Teaching and Learning Grant ($800)", "University of San Diego CAS Committee for Undergraduate Teaching and Learning",
  "Spring 2026", "Enhancing Student-Faculty Interaction Fund grant ($500)", "University of San Diego Office of the Provost",
...
tribble(
  ...
  "April 2026", "Surprise-related brain regions encode high-level visual features of magic tricks", "Social and Affective Neuroscience Society Annual Meeting",
  "Feb 2026", "On Silence: Musings from a cognitive neuroscientist", "University of San Diego Humanities Center",
...
tribble(
  ...
  "Feb 2026", "[Podcast guest (science)](https://podcasts.apple.com/us/podcast/how-the-brain-makes-sense-of-the-world-through-emotion/id1644441847?i=1000748218498)", "At the Edge of It All by the University of San Diego",
  "May 2024", "[Radio/podcast guest (trivia, science)](https://www.npr.org/transcripts/1196979444)", "Life Kit by NPR",
  "Feb 2024", "[Radio/podcast guest (trivia, science)](https://www.npr.org/2024/02/18/1232301993/a-new-study-finds-the-memory-systems-that-give-trivia-champions-an-edge)", "NPR Weekend Edition Sunday",
  "Feb 2024", "[Radio/podcast guest (trivia, science)](https://www.sciencefriday.com/segments/jeopardy-winner-memory-recall/)", "Science Friday",
...
tribble(
  ...
  "Committee member", "2026 - ", "Conference program committee", "Social & Affective Neuroscience Society", "",
  "Committee member", "2026 - ", "Participant Pool committee", "University of San Diego Dept of Neuro, Cog & Beh", "",
  "Committee member", "2026 - ", "Space committee", "University of San Diego Dept of Neuro, Cog & Beh", "",
  "President", "2026 - ", "AAUP chapter", "University of San Diego", "",
  "Coordinator", "2026 - ", "Computational & statistics faculty community of practice", "University of San Diego", "",
  "Conference abstract reviewer", "2025 - ", "", "Social & Affective Neuroscience Society; Society for Affective Science", "",
  "Application reviewer", "2026", "STAR Undergraduate Summer Research Fellowship", "University of San Diego", "",
  "Teller", "2025 - 2026", "Academic Assembly", "University of San Diego College of Arts & Sciences", "",
  ...
  "Peer reviewer", " ", " ", "ad hoc", "Cerebral Cortex; Neuropsychologia; Social, Cognitive, & Affective Neuroscience; Emotion; Humanities & Social Sciences Communications"
) %>% 
...
tribble(
  ~Year, ~Workshop, ~Desc,
  "2026 - 2027", "[Faculty Seminar on the Catholic Intellectual Tradition](https://www.sandiego.edu/offices/mission-integration/faculty-seminar.php)", "University of San Diego",
  "2025", "[Faculty Success Program](https://www.ncfdd.org/programs/faculty-success-program/)", "NCFDD",
...
```{r}
# similarly, re-order to boost current RAs up to top
tribble(
  ~ Name, ~ Year, ~ Where, ~ Position, ~ Awards,
  "Chiara Cossio", "2026 - ", "University of San Diego", "Post-baccalaureate research assistant", "",
  "Alyssa Arjona-Gonzaga", "2026 - ", "University of San Diego", "Undergraduate research assistant", "",
  # "Phoebe Rodgers", "2026 - ", "University of San Diego", "Undergraduate research assistant", "", # 2026-09-10 taken off list as she's dropping this semester. Leaving commented in case she comes back in the spring!
  "Mariah Wagner", "2026 - ", "University of San Diego", "Undergraduate research assistant", "",
  "Finley Sasena", "2026 - ", "University of San Diego", "Undergraduate research assistant", "",
  "Jasmine Chatha", "2026 - ", "University of San Diego", "Undergraduate research assistant", "", 
  "Ashanthy Pardilla", "2026 - ", "University of San Diego", "Undergraduate research assistant", "",
  "Troy Fernandez", "2026 - ", "University of San Diego", "Undergraduate research assistant", "",
  "Bea Racho", "2026 - ", "University of San Diego", "Undergraduate research assistant", "",
  "Kayla Operana", "2026 - ", "University of San Diego", "Undergraduate research assistant", "",
  "Gabby Jensen", "2026 - ", "University of San Diego", "Undergraduate research assistant", "",
  "Sophie Johnston", "2025 - ", "University of San Diego", "Undergraduate research assistant", "",
  "Clara Geuzaine", "2026", "University of San Diego", "Undergraduate research assistant", "",
  "Abraham Funk", "2026", "University of San Diego", "Undergraduate research assistant", "",
  "Lucy Cook", "2026", "University of San Diego", "Undergraduate research assistant", "",
  "Annelyse Basha", "2026", "University of San Diego", "Undergraduate research assistant", "",
  "Valentina Alvarado", "2026", "University of San Diego", "Undergraduate research assistant", "",
  "Sonya Patel", "2025 - 2026", "University of San Diego", "Undergraduate research assistant", "",
  "Ari Bradford", "2025 - 2026", "University of San Diego", "Undergraduate research assistant", "",
  "Meera Sethi", "2024 - 2025", "Emory University", "Undergraduate research assistant", "",
  "Lauren Wilkins", "2020 - 2022", "Columbia University", "Undergraduate research assistant & honors thesis student", "Class of 1939 Summer Research Fellowship, summer 2020; current PhD student in clinical psychology at Miami University"
) %>% 
